...
the unidimensional polynomial regression. 
...
class polynomial:
	...
	of a simple polynomial regression.
	...
	def __init__(self,X,y,y_errors,order = 1):
	...
	def plot(self,nPoints = __PLOT_POINTS__,**kwargs):
		...
		if not self.fitted:
			...
			X_mod = np.linspace(xmin,xmax,nPoints)
